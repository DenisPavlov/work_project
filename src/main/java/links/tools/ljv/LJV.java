package links.tools.ljv;//- links.tools.ljv.LJV.java --- Generate a graph of an object, using Graphviz
...
//- $Id: links.tools.ljv.LJV.java,v 1.1 2004/07/14 02:03:45 jham005 Exp $
...
class LJV {
    ...
    static class Context {
        ...
        /**
         ...
         label for an object from the same package as links.tools.ljv.LJV (true) or
    ...
    public static void drawGraph( Context ctx, Object obj, String file ) {
        try {
            File        dotfile = ctx.keepDotFile == null ? File.createTempFile( "links.tools.ljv.LJV", "dot" ) : new File( ctx.keepDotFile );
...
//- links.tools.ljv.LJV.java ends here