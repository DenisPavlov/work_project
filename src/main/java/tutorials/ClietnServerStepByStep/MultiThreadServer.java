...
public class MultiThreadServer {
    ...
    static ExecutorService executeIt = Executors.newFixedThreadPool(15);// TODO: 13.03.18 Настраиваемый параметр

    public static void main(String[] args) {

        // стартуем сервер на порту 3345 и инициализируем переменную для обработки консольных команд с самого сервера
        try (ServerSocket server = new ServerSocket(3345)) { // TODO: 13.03.18 Настраиваемый параметр
