...
-----
- topjava 
    - остановился (не смотрел) lesson04, 3. Spring: инициализация и популирование DB,
    - прочитал - Смотреть по плюсам!
    - todo
      - добавить ломбок
      - тест контенеры
      - docker
...
- Программирование на C для начинающих 
  - стр. 228 Глава 23. Сортировка по алфавиту и упорядочение данных
...
Книги
--------------
- Экстремальное программирование. Кен Бег
