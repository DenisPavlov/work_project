...
Spring в действии 
-----------------------
- стр 408 9.3 Соединяем все вместе: последовательность pizza 
- научиться запускать web flow приложение и начать главу с начала!!!

topjava
---
- Видео - lesson 4 - 1. JdbcMealRepositoryImpl + MealServiceTest - посмотрел
- Сылки - Java 8: Потоки
- ДЗ - lesson 3 - доделал
- как правильно организовать юнит тесты? Хорошая ли практика создавать контекст приложения в юнит тестах. Или 
нужно просто тестировать свой не большой юнит (класс) ?

JS
---
- стр 258 - Псевдомассив аргументов "arguments"
...
- что такое web-контейнер?
- попробовать Jenkins
- лямбда исчисления и теория категорий
- UML
- java.util.regex
- ForkJoin
