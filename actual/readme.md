...
- не приступать к книге пока не научусь создавать нормальный spring проект и запускать его на tomcat
- после прочтения книги пройтись по всем примерам еще раз (без моих изменений)

topjava
---
- Видео - 4. Обзор используемых в проекте технологий. Интеграция ПО.
- Сылки - Java 8: Потоки
